...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { level: @dog.level, name: @dog.name, points: @dog.points, stamina: @dog.stamina } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { level: @dog.level, name: @dog.name, points: @dog.points, stamina: @dog.stamina } }
